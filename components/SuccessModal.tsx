        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-3 w-full">
            <Link
              href="/"
              onClick={onClose}
              className="flex-1 py-2 px-4 rounded-xl border border-border-subtle text-sm font-medium text-zinc-300 hover:bg-white/5 transition-all text-center"
            >
              Home
            </Link>
            <button
              onClick={onClose}
              className="flex-1 py-2 px-4 rounded-xl bg-brand text-sm font-medium text-black hover:bg-brand-light transition-all"
            >
              Submit Another
            </button>
          </div>
